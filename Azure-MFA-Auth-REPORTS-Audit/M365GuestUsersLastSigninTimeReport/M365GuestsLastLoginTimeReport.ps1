...
if((Test-Path -Path $ExportCSV) -eq "True")
{
    ...
    Write-Host "~~ Check out " -NoNewline -ForegroundColor Green; Write-Host "" -ForegroundColor Yellow -NoNewline; Write-Host " to get access to 1800+ Microsoft 365 reports. ~~" -ForegroundColor Green `n`n
